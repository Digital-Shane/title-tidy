...
cp "$VIDEO_SRC" "$SHOW1_DIR/Season 1/Breaking.Bad.S01E01.1080p.mkv"
touch "$SHOW1_DIR/Season 1/Breaking.Bad.S01E01.1080p.nfo"
touch "$SHOW1_DIR/Season 1/Breaking.Bad.S01E01.1080p.jpg"
cp "$VIDEO_SRC" "$SHOW1_DIR/Season 1/breaking.bad.s01e02.mkv"
touch "$SHOW1_DIR/Season 1/breaking.bad.s01e02.nfo"
cp "$VIDEO_SRC" "$SHOW1_DIR/Season 1/Breaking.Bad.1x03.mkv"
touch "$SHOW1_DIR/Season 1/Breaking.Bad.1x03.png"
cp "$VIDEO_SRC" "$SHOW1_DIR/Season 1/Episode 4.mkv"
cp "$VIDEO_SRC" "$SHOW1_DIR/Season 1/Better.Call.Saul.1.05.1080p.mkv"
touch "$SHOW1_DIR/Season 1/Better.Call.Saul.1.05.1080p.nfo"
# Season 2 episodes - context fallback (no season token in filename)
cp "$VIDEO_SRC" "$SHOW1_DIR/s2/Episode 5.mkv"    # S02E05 via parent
...
cp "$VIDEO_SRC" "$SHOW2_DIR/Season-1/Stranger.Things.S01E01.mkv"
cp "$VIDEO_SRC" "$SHOW2_DIR/Season-1/Stranger.Things.1x02.mkv"
cp "$VIDEO_SRC" "$SHOW2_DIR/Season-2/2.03.mkv" # dotted -> S02E03
...
cp "$VIDEO_SRC" "$SHOW3_DIR/5/The.Office.S05E01.mkv"
cp "$VIDEO_SRC" "$SHOW3_DIR/5/Episode 2.mkv" # context fallback S05E02
